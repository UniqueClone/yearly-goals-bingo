...
import { InputGridRenderer } from "./components/InputGridRenderer";
...
function App() {
  ...
  return (
    <div className="App">
      <header>
        <title>2025 Goals Bingo Generator</title>
      </header>
      <body>
        <Introduction />
        <InputGridRenderer />
...
const Introduction: React.FC = () => {
  return (
    <div>
      <h1>2025 Goals Bingo Generator!</h1>
      <h2>What is this?</h2>
      <p>
        This is a tool to help you generate a PDF of your goals for the year
        2025. You can use this to help you visualize your goals and make them
        more real.
      </p>
      <p>
        New Year's resolutions are often forgotten by the end of January, and
        often because they are unrealistic and people set an unrealistic number
        of goals. This tool is designed to help you choose goals with a higher
        chance of success.{" "}
      </p>
      <p>
        You do not aim to complete all of your goals, but rather to complete a
        bingo line of goals. Good luck!
      </p>
    </div>
  );
};
